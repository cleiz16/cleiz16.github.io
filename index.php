			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-bottom: 10px;">
					...
					<div class="row shadow_box" style="margin-right: 5px;background-color: white">
       					<div id="googleMap" style="width:100%;height:567px"></div>
       				</div>
				</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	   				...
	   				<div id="aqi_measure_place" class="row shadow_box" style="background-color: white;background-size: 100% 100%;">
	   					<div class="container-fluid">
	   						<div class="row text-left">
	   							...
	   							<p style="margin-left: 5px; margin-top: 10px;"><u><b id="location_sensor">_</b></u></p>
	   						</div>
	   					<div class="row">
					...
					<div class="col-lg-6 col-sm-6 col-md-12 ">
	   				...
	   				<div id="divInfo" class="row text-center shadow_box" style="margin-bottom: 5px;padding-top: 15px;background-color: white;background-size: 100% 100%;">
	   					<?php
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-6 col-lg-6 col-sm-6">
						<div class="row text-center shadow_box" style="margin-right: 5px; margin-bottom: 10px;background-color: white">
...
<!-- </div> -->
	...
	<script type="text/javascript" src="./resources/js/air-quality/realtime.js"></script>
	...
	<?php 
		...
		// require_once("./src/common/changePosition.php")	;
	?>

	<script type="text/javascript" src="./resources/js/common/googleMap.js"></script>
