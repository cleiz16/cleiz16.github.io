    ...
    if (zone ==1){
        ...
        var href= ["#","./lqi/index.php","./wqi/index.php","#","#"];
    }else if (zone==2) {
        path_icon_map ="../resources/img/marker/";
        var href= ["#","../lqi/zone2.php","../wqi/zone2.php","#","#"];
    }else if (zone==3) {
        path_icon_map ="../resources/img/marker/";
        var href= ["#","../lqi/zone3.php","../wqi/zone3.php","#","#"];
    }else if (zone==4) {
        path_icon_map ="../resources/img/marker/";
        var href= ["#","../lqi/zone4.php","../wqi/zone4.php","#","#"];
    }
            function newPosition(){
            position = new google.maps.LatLng(21.028871,105.9010031);    
