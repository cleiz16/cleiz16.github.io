function add_Warning(AQI){
    ...
    if(AQI <=0){
        ...
        document.getElementById('pinIcon').src="../resources/img/icon/nodata.png"
        ...
        document.getElementById('pinIcon').src="../resources/img/icon/happy.png"
        ...
        document.getElementById('pinIcon').src="../resources/img/icon/normal.png"
        ...
        document.getElementById('pinIcon').src="../resources/img/icon/sad.png"
        ...
        document.getElementById('pinIcon').src="../resources/img/icon/danger.png"

    }else if((AQI<=300)&&(AQI>200)){
        aqi_display.classList.add("purple-div");
        document.getElementById('warning').innerHTML = "Rất Xấu";
        document.getElementById('description').innerHTML = "Nhóm nhạy cảm tránh ra ngoài. Những người khác hạn chế ở bên ngoài";
        document.getElementById('pinIcon').src="../resources/img/icon/extdanger.png"
        ...
        document.getElementById('pinIcon').src="../resources/img/icon/toxic.png";
